...
public class BasicSlider extends AbstractComponent implements Slider {
	...
	public BasicSlider(String text, double value, double minimum, double maximum, double increment, ValueDisplay display) {
		...
		this.value = (double)((long)(Math.round(value / increment) * 1000000) * (long)(increment * 1000000)) / 1000000 / 1000000;
	...
	public void setValue(double value) {
		...
		value = Math.max(minimum, Math.min(maximum, value));
		//This over complicated mess is needed because simply multiplying doubles is too inaccurate!
		this.value = (double)((long)(Math.round(value / increment) * 1000000) * (long)(increment * 1000000)) / 1000000 / 1000000;
		//Old nonsense: this.value = value - (Math.round((value % increment) / increment) * increment);
