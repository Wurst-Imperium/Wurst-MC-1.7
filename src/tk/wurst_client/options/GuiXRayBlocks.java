...
public class GuiXRayBlocks extends GuiScreen
{
	private GuiScreen prevMenu;
	public static GuiXRayBlockList blockList;

	public GuiXRayBlocks(GuiScreen par1GuiScreen)
    {
	...
	public void initGui()
	{
		this.blockList = new GuiXRayBlockList(this.mc, this);
	...
	protected void actionPerformed(GuiButton clickedButton)
    {
		if(clickedButton.enabled)
        {
            ...
            {//Add
            	this.mc.displayGuiScreen(new GuiAddBlock(this));
